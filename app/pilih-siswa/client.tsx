...
import { User, Lock, GraduationCap, AlertCircle, Info } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { InputOTP, InputOTPGroup, InputOTPSlot } from '@/components/ui/input-otp';
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger, DialogDescription } from '@/components/ui/dialog';

export interface SiswaPublik {
  id: string;
  nama: string;
  kelas: string | null;
...
export default function PilihSiswaClient({ initialSiswaList }: { initialSiswaList: SiswaPublik[] }) {
  const router = useRouter();
  const [siswaList] = useState<SiswaPublik[]>(initialSiswaList);
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <Dialog>
            ...
            <DialogContent className="sm:max-w-md">
              <DialogHeader>
                <DialogTitle className="text-2xl font-black text-center text-blue-600">Cara Penggunaan</DialogTitle>
                <DialogDescription className="text-center">
                  Ikuti langkah-langkah berikut untuk mulai belajar
                </DialogDescription>
              </DialogHeader>
              <div className="flex flex-col gap-4 py-4 px-2">
                <ol className="list-decimal pl-4 space-y-3 font-medium text-slate-700">
                  <li>Login atau pilih nama siswa yang sesuai.</li>
